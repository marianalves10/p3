[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/_ERcT-z8)
# Semantic Analysis
...
### Docker
If you're using the dockerized environment, to run `uc_sema.py` directly you should run:
```sh
docker-compose run --rm test uc/uc_sema.py -h
``` 

```sh
# Example: running test 01
docker-compose run --rm test uc/uc_sema.py tests/in-out/t01.in
``` 
